        ...
        <div class="max-w-xl lg:max-w-lg">
          ...
          <div class="mt-6 flex max-w-md gap-x-4">
            ...
            <button v-if="!isConnected" @click="start"
                    class="flex-none rounded-md bg-green-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500">
              Start
            </button>
            <button v-else @click="stop"
                    class="flex-none rounded-md bg-rose-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-rose-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500">
              Stop
            </button>
          </div>
        </div>
