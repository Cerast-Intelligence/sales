    ...
    <main class="relative isolate">
      ...
      <div class="px-6 pt-14 lg:px-8">
        <div class="mx-auto max-w-2xl pt-24 text-center sm:pt-40">
          <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Cerast Intelligence</h2>
        ...
        <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 text-gray-300 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
          <div v-for="value in values" :key="value.name" class="relative pl-9">
            <dt class="inline font-semibold text-white">
              <component :is="value.icon" class="absolute left-1 top-1 h-5 w-5 text-rose-500" aria-hidden="true" />
              {{ value.name }}
            </dt>
            {{ ' ' }}
      ...
      <div class="relative isolate -z-10 mt-32 sm:mt-40">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="mx-auto flex max-w-2xl flex-col gap-16 bg-white/5 px-6 py-16 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
            <NuxtImg class="h-96 w-full flex-none rounded-2xl object-cover shadow-xl lg:aspect-square lg:h-auto lg:max-w-sm" src="/images/background.webp" alt="" />
            <div class="w-full flex-auto">
              <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Start monitoring now</h2>
              <p class="mt-6 text-lg leading-8 text-gray-300">For only 50 € a month you get access to all found security issues.<br> Access them via our easy to use stream tool.</p>
              ...
              <div class="mt-10 flex">
                <NuxtLink href="/#subscribe" class="text-sm font-semibold leading-6 text-rose-500">See our subscription plan <span aria-hidden="true">&rarr;</span></NuxtLink>
              </div>
            </div>
          </div>
        </div>
